	...
	<form method="post" action="cadastroCliente.php">
		  ...
		  <div class="form-row">
    		<div class="form-group col-md-6">
      			...
      			<input name="senha" type="text" class="form-control" id="nome" placeholder="Senha">
    		</div>
    		<div class="form-group col-md-6">
      			<label for="confirma">Confirmar Senha</label>
      			<input name="confirmar_senha" type="text" class="form-control" id="sobrenome" placeholder="Confirmar Senha">
    		</div>			
  		</div>  		
